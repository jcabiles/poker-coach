...
// and auto-reveal. The buttons are always offered once the hand is complete —
// a range-inspection aid — including hands the hero played to showdown.
      ...
      {showdown.length > 0 ? (
        ...
        <p className="sim-showdown-fold">
          {heroFolded
            ...
            : "The pot was taken down before showdown. Reveal the villains below."}
        </p>
      )}
