...
# 4. run it
poker-coach            # start backend :8008 + frontend :7173 in the background
poker-coach stop       #   stop / restart / status also work
```
Open <http://localhost:7173>. No direnv? Use `./scripts/serve.sh start` instead — same launcher. Full details below.
