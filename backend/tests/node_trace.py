...
SPOTS: tuple[Spot, ...] = (
    ...
    Spot(
        "flop_lowspr_commit_overpair",
        ("Ah", "Ad"),
        ("Ks", "7d", "2c"),
        _facing(10.0, 15.0, jam=15.0),
        20.0,
        15.0,
        1,
        10.0,
