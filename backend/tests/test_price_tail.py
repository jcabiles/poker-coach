...
HEAD_VECTORS: dict[tuple[str, str, float, bool], tuple[float, float, float]] = {
    ("calling_station", "AIR", 0.3, True): (
        0.32863826529923007,
        0.654348669298996,
        0.017013065401773896,
    ),  # noqa: E501
    ("calling_station", "AIR", 0.55, True): (
        0.4442977556616227,
        0.5416201211875021,
        0.014082123150875054,
    ),  # noqa: E501
    ("calling_station", "AIR", 0.9, True): (
        0.512369577736908,
        0.47527331604589856,
        0.01235710621719336,
    ),  # noqa: E501
    ("calling_station", "AIR", 1.1, True): (
        0.512369577736908,
        0.47527331604589856,
        0.01235710621719336,
    ),  # noqa: E501
    ("calling_station", "AIR", 1.11, True): (
        0.5853964944886938,
        0.4040969839291483,
        0.010506521582157854,
    ),  # noqa: E501
    ("calling_station", "AIR", 1.45, True): (
        0.5853964944886938,
        0.4040969839291483,
        0.010506521582157854,
    ),  # noqa: E501
    ("calling_station", "AIR", 1.5, True): (
        0.5853964944886938,
        0.4040969839291483,
        0.010506521582157854,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 0.3, True): (
        0.1264368676453414,
        0.8653813450919708,
        0.008181787262687723,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 0.55, True): (
        0.1912011071454585,
        0.8012236870857309,
        0.007575205768810545,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 0.9, True): (
        0.23703606892350199,
        0.7558180152955222,
        0.007145915780975845,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.1, True): (
        0.23703606892350199,
        0.7558180152955222,
        0.007145915780975845,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.11, True): (
        0.2945223672964382,
        0.6988701332618138,
        0.006607499441748056,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.45, True): (
        0.2945223672964382,
        0.6988701332618138,
        0.006607499441748056,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.5, True): (
        0.2945223672964382,
        0.6988701332618138,
        0.006607499441748056,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.11, False): (
        0.18737869692917716,
        0.8084175319049173,
        0.004203771165905569,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.45, False): (
        0.18737869692917716,
        0.8084175319049173,
        0.004203771165905569,
    ),  # noqa: E501
    ("calling_station", "ACE_HIGH", 1.5, False): (
        0.18737869692917716,
        0.8084175319049173,
        0.004203771165905569,
    ),  # noqa: E501
    ("passive_fish", "AIR", 1.11, False): (
        0.9369141963528489,
        0.031269910541074135,
        0.03181589310607702,
    ),  # noqa: E501
    ("passive_fish", "AIR", 1.45, False): (
        0.9369141963528489,
        0.031269910541074135,
        0.03181589310607702,
    ),  # noqa: E501
    ("passive_fish", "AIR", 1.5, False): (
        0.9369141963528489,
        0.031269910541074135,
        0.03181589310607702,
    ),  # noqa: E501
    ("passive_fish", "ACE_HIGH", 1.11, False): (
        0.7993323159140884,
        0.1667378540940706,
        0.03392982999184103,
    ),  # noqa: E501
    ("passive_fish", "ACE_HIGH", 1.45, False): (
        0.7993323159140884,
        0.1667378540940706,
        0.03392982999184103,
    ),  # noqa: E501
    ("passive_fish", "ACE_HIGH", 1.5, False): (
        0.7993323159140884,
        0.1667378540940706,
        0.03392982999184103,
    ),  # noqa: E501
